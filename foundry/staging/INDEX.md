...
V0.3, V0.4, V0.5, V0.6, and V0.7 remain manual. This index does not create folders, update Linear, update GitHub issues, trigger Codex, mutate the project registry, or enable automation.
...
| `foundry-launcher-v0.7-first-project-initiation-example` | Foundry Launcher V0.7 First Full Project Initiation Example | `new_module` | `needs_review` | Foundry / Foundry Launcher | Pending Dobromir review | Documentation-only full initiation example; real implementation blocked. | [foundry-launcher-v0.7-first-project-initiation-example/](foundry-launcher-v0.7-first-project-initiation-example/) |
