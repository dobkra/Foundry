...
V0.3 remains manual. This index does not create folders, update Linear, update GitHub issues, trigger Codex, mutate the project registry, or enable automation.
