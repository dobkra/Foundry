...
This folder contains staged Launcher handoff packets.

`foundry/staging/` is the canonical location for Foundry-level and governance staging packets. Project-local staging may later be introduced inside the relevant project repositories.
